...
class __$$NoInternetImplCopyWithImpl<$Res>
    extends _$ApiExceptionCopyWithImpl<$Res, _$NoInternetImpl>
...
class _$NoInternetImpl implements NoInternet {
  const _$NoInternetImpl(this.path, this.message, this.code, this.statusCode);
  ...
  @override
  String toString() {
    return 'ApiException.noInternet(path: $path, message: $message, code: $code, statusCode: $statusCode)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return noInternet(path, message, code, statusCode);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return noInternet?.call(path, message, code, statusCode);
  }
...
abstract class NoInternet implements ApiException {
  const factory NoInternet(final String path, final String? message,
      final String? code, final int? statusCode) = _$NoInternetImpl;
