...
UserInfoDto _$UserInfoDtoFromJson(Map<String, dynamic> json) => UserInfoDto(
      ...
      listManagementVhrOrg: (json['listManagementVhrOrg'] as List<dynamic>?)
          ?.map((e) =>
              ListChartPermissionElement.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      listSecretaryOrg: (json['listSecretaryOrg'] as List<dynamic>?)
          ?.map((e) => SecretaryOrg.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      listManagementVhrOrgIsDefault: (json['listManagementVhrOrgIsDefault']
              as List<dynamic>?)
          ?.map((e) =>
              ListChartPermissionElement.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      tgd: json['tgd'] == null
          ? null
          : Tgd.fromJson(json['tgd'] as Map<String, dynamic>),
...
ListChartPermissionElement _$ListChartPermissionElementFromJson(
...
Map<String, dynamic> _$ListChartPermissionElementToJson(
        ListChartPermissionElement instance) =>
    <String, dynamic>{
...
Tgd _$TgdFromJson(Map<String, dynamic> json) => Tgd(
      employeeId: (json['employeeId'] as num?)?.toInt(),
      fullName: json['fullName'] as String?,
...
Map<String, dynamic> _$TgdToJson(Tgd instance) => <String, dynamic>{
      'employeeId': instance.employeeId,
      'fullName': instance.fullName,
...
SecretaryOrg _$SecretaryOrgFromJson(Map<String, dynamic> json) => SecretaryOrg(
      sysOrganizationId: (json['sysOrganizationId'] as num?)?.toInt(),
      name: json['name'] as String?,
      path: json['path'] as String?,
...
Map<String, dynamic> _$SecretaryOrgToJson(SecretaryOrg instance) =>
    <String, dynamic>{
      'sysOrganizationId': instance.sysOrganizationId,
      'name': instance.name,
      'path': instance.path,
